...
export default function SourcesPage() {
  ...
  <h2>Evidence retrieval</h2><p>The <a href="/evidence/">evidence browser</a> retrieves exact excerpts from eight versioned Atlas methodology documents. It preserves document hashes, sections, dates and linked dataset manifests. These are project descriptions, not independent observations or a complete report archive. Keyword matches do not establish factual support; missing evidence and UNKNOWN freshness remain explicit. <a href="/data/atlas-evidence/1.0.0/manifest.json">Corpus release</a>.</p>
  <h2>AI Analyst</h2><p>The <a href="/analyst/">local analyst</a> answers supported questions using exact project-document excerpts, verified downstream topology and registered hypothetical scenarios. Citations retain source versions, dates and limitations. Calculations and modelled results remain distinct from observations; unsupported measurements and interpretations stay UNKNOWN. It introduces no new upstream source or runtime language-model service.</p>
  </article>;
}
